...
export class AuthService {
    ...
    async signin(singinDto: SigninDto) {
        ...
        const accessToken = await this.generateAccessToken(user.id, user.verified)
    ...
    generateAccessToken(userId: string, verified: boolean): Promise<String> {
        return this.jwtService.signAsync({ sub: userId, verified })
    }
}
