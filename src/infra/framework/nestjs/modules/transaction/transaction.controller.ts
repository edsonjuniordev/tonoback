...
import { OptionalParseUUIDPipe } from '@infra/framework/nestjs/pipes/OptionalParseUUIDPipe';
import { TransactionType } from './entities/transaction';
import { OptionalParseEnumPipe } from '@infra/framework/nestjs/pipes/OptionalParseEnumPipe';
